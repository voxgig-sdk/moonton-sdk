...
MoontonSDK._make_feature = _make_feature


function MoontonSDK.new(options)
  local self = setmetatable({}, MoontonSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function MoontonSDK:options_map()
...
function MoontonSDK:get_utility()
  return Utility.copy(self._utility)
end


function MoontonSDK:get_root_ctx()
  return self._rootctx
end


function MoontonSDK:prepare(fetchargs)
...
function MoontonSDK:direct(fetchargs)
...
-- by passing it.
function MoontonSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function MoontonSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "MoontonSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function MoontonSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = MoontonSDK.new(sdkopts)
  sdk.mode = "test"
