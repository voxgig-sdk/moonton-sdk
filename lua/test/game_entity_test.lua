...
describe("GameEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MOONTON_TEST_GAME_ENTID JSON to run live")
      return
    end
...
function game_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MOONTON_TEST_GAME_ENTID")
