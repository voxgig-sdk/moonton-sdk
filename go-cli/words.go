...
func registerSDKWords(r *eng.Registry, client *sdk.MoontonSDK) {
...
func runOp(client *sdk.MoontonSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
