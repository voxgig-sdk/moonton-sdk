// Command Moonton-cli is a CLI + REPL for the Moonton SDK,
...
const prompt = "moonton"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "game"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MOONTON_APIKEY (api key), MOONTON_BASE (base url override)")
