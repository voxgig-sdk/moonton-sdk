...
|---|---|---|
| `ts/` | @voxgig-sdk/moonton-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/moonton-sdk \
      --repository voxgig-sdk/moonton-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/moonton-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/moonton-sdk --id=<id>` removes one.
