...
class MoontonRatelimitFeature extends MoontonBaseFeature
{
    ...
    private function _acquire(MoontonContext $ctx): void
    {
    ...
    private function _track(MoontonContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
