...
class MoontonTimeoutFeature extends MoontonBaseFeature
{
    ...
    private function _with_timeout(MoontonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MoontonContext $_ctx, float $ms): void
    {
        $client = $this->client;
