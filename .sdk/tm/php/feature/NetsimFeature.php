...
class MoontonNetsimFeature extends MoontonBaseFeature
{
    ...
    private function _simulate(MoontonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MoontonContext $ctx, array $applied): void
    {
        $client = $this->client;
