...
// Moonton SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MoontonTestFeature extends MoontonBaseFeature
{
    ...
    public function init(MoontonContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MoontonContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MoontonContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MoontonContext $ctx, $op, $args): array
    {
