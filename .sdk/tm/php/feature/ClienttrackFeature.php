...
// Moonton SDK clienttrack feature
...
class MoontonClienttrackFeature extends MoontonBaseFeature
{
    ...
    public function PostConstruct(MoontonContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Moonton-SDK';
