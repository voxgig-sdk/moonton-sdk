...
{
    private static function utility(): MoontonUtility
    {
        return new MoontonUtility();
    }
    ...
    private static function ctx(array $over = []): MoontonContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MoontonContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MoontonOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MoontonError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MoontonOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MoontonMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MoontonOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MoontonMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MoontonOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MoontonMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MoontonSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MoontonMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MoontonResponse([]),
            'result' => new MoontonResult([]),
        ]);
        [, $err] = MoontonMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MoontonSpec([]),
            'response' => null,
            'result' => new MoontonResult([]),
        ]);
        [, $err] = MoontonMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MoontonSpec(['step' => 's']),
            'response' => new MoontonResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MoontonResult([]),
        ]);
        [, $err] = MoontonMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MoontonSpec(['step' => 's']),
            'response' => new MoontonResponse(self::resp(200, ['v' => 1])),
            'result' => new MoontonResult([]),
        ]);
        [, $err] = MoontonMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MoontonSpec(['step' => 's']),
            'response' => new MoontonResponse(self::resp(200, ['v' => 2])),
            'result' => new MoontonResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MoontonMakeResponse::call($ctx);
    ...
    {
        $preset = new MoontonResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MoontonSpec([]),
            'response' => new MoontonResponse([]),
            'result' => new MoontonResult([]),
        ...
        [$got, $err] = MoontonMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MoontonResult([])]);
        [, $err] = MoontonMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MoontonSpec([]), 'result' => null]);
        [, $err] = MoontonMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MoontonSpec(['step' => 's']),
            'result' => new MoontonResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MoontonOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MoontonMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MoontonSpec(['step' => 's']),
            'result' => new MoontonResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MoontonOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MoontonMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MoontonResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MoontonSpec([]),
            'result' => new MoontonResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MoontonMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MoontonMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MoontonError('boom', 'boom');
        $utility->fetcher = function (MoontonContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MoontonSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MoontonMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MoontonContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MoontonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MoontonResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MoontonContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MoontonSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MoontonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MoontonResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MoontonSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MoontonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MoontonMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MoontonMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MoontonResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MoontonDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MoontonResult(['ok' => false])]);
        $this->expectException(MoontonError::class);
        MoontonDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MoontonResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MoontonMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MoontonMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MoontonBaseFeature();
        $b = new MoontonBaseFeature();
        MoontonFeatureAdd::call($ctx, $a);
        MoontonFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MoontonBaseFeature
    {
        $f = new MoontonBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MoontonFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?MoontonSpec $spec): MoontonContext
    {
    ...
    private static function auth_bags(): MoontonSpec
    {
        return new MoontonSpec(['headers' => [], 'query' => []]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MoontonPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MoontonResponse(['headers' => null]),
            'result' => new MoontonResult([]),
        ]);
        MoontonResultHeaders::call($ctx);
