...
// Moonton SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MoontonOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MoontonOmni::structfix($now, Struct::undef()))
                        !== json_encode(MoontonOmni::structfix($val, Struct::undef()))) {
