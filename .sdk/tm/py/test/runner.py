...
class MoontonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MoontonTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MoontonTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MoontonTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
