...
class MoontonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MoontonTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MoontonTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MoontonTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
