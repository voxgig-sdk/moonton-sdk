...
_runner = makeRunner(TEST_JSON_FILE, MoontonSDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = MoontonSpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MoontonSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MoontonSDK.test(None, setup.get('a') or {})
