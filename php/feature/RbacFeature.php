...
class MoontonRbacFeature extends MoontonBaseFeature
{
    ...
    private function _required(MoontonContext $ctx): ?string
    {
    ...
    private function _reject(MoontonContext $ctx, string $required): void
    {
    ...
    private function _track(MoontonContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
