...
class MoontonCacheFeature extends MoontonBaseFeature
{
    ...
    private function _through(MoontonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
