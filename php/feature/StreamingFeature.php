...
class MoontonStreamingFeature extends MoontonBaseFeature
{
    ...
    private function _iterate(MoontonResult $result): \Generator
    {
    ...
    private function _streamable(MoontonContext $ctx): bool
    {
