...
class MoontonProxyFeature extends MoontonBaseFeature
{
    ...
    public function init(MoontonContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MoontonContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
