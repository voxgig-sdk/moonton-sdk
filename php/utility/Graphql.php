...
class MoontonGraphql
{
    ...
    // equivalent.
    public static function body(MoontonContext $ctx): mixed
    {
    ...
    public static function errors(MoontonContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
