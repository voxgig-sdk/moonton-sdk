...
// Moonton SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MoontonMakeRequest
{
    public static function call(MoontonContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MoontonResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MoontonResponse($fetched);
        } else {
