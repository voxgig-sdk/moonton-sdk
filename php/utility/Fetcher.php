...
class MoontonFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MoontonSDK/1.0)';
    ...
    public static function call(MoontonContext $ctx, string $fullurl, array $fetchdef): array
    {
