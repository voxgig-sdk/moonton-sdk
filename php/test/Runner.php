...
class MoontonTestRunner
{
    ...
    {
        $live = self::getenv('MOONTON_TEST_LIVE');
        $override = self::getenv('MOONTON_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MOONTON_TEST_EXPLAIN');
...
class_alias('MoontonTestRunner', 'Runner');
class_alias('MoontonHelpers', 'Helpers');
