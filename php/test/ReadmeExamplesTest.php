...
// Moonton SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MoontonSDK::test)
...
{
    private const SDK_CLASS = 'MoontonSDK';
    ...
    private const SDK_BASE = 'moonton_sdk';
