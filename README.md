...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/moonton` | `npm install @voxgig-sdk/moonton` |
| Python | `voxgig-sdk-moonton` | `pip install voxgig-sdk-moonton` |
| PHP | `voxgig-sdk/moonton` | `composer require voxgig-sdk/moonton` |
| Golang | `github.com/voxgig-sdk/moonton-sdk/go` | `go get github.com/voxgig-sdk/moonton-sdk/go` |
| Ruby | `voxgig-sdk-moonton` | `gem install voxgig-sdk-moonton` |
| Lua | `voxgig-sdk-moonton` | `luarocks install voxgig-sdk-moonton` |
