...
The Ruby SDK for the Moonton API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.Moonton(nil).load(
  { "id" => "test01" }, nil
)
...
```
rb/
├── Moonton_sdk.rb       -- Main SDK module
