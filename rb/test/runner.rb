...
module MoontonTestRunner
  ...
  def self.env_override(m)
    live = getenv("MOONTON_TEST_LIVE")
    override = getenv("MOONTON_TEST_OVERRIDE")
    ...
    explain = getenv("MOONTON_TEST_EXPLAIN")
    m["MOONTON_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MoontonTestRunner
Helpers = MoontonHelpers
Vs = VoxgigStruct
