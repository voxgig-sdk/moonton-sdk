...
(0, node_test_1.describe)('exists', async () => {
    ...
    //
    // MoontonSDK.test() is synchronous — it returns the client, not a promise
    ...
    (0, node_test_1.test)('test-mode', () => {
        const testsdk = __1.MoontonSDK.test();
        (0, node_assert_1.equal)(testsdk instanceof __1.MoontonSDK, true, 'MoontonSDK.test() must return a client synchronously');
    });
});
