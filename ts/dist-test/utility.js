...
function envOverride(m) {
    if ('TRUE' === process.env.MOONTON_TEST_LIVE ||
        'TRUE' === process.env.MOONTON_TEST_OVERRIDE) {
    ...
    m.MOONTON_TEST_EXPLAIN = process.env.MOONTON_TEST_EXPLAIN || m.MOONTON_TEST_EXPLAIN;
    return m;
}
