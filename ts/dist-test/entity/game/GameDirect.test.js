...
(0, node_test_1.describe)('GameDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('MOONTON_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MoontonSDK({
...
function liveScenariosActive() { return false && process.env.MOONTON_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MoontonSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.MOONTON_APIKEY,
        }));
        let idmap = env['MOONTON_TEST_GAME_ENTID'];
    ...
    const client = new __1.MoontonSDK({
        base: 'http://localhost:8080',
