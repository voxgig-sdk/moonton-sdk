# Moonton SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MoontonSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MoontonSDK(...) and MoontonSDK.test(...) become
#      MoontonSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "moonton_sdk"
_SDK_CLASS = "MoontonSDK"
