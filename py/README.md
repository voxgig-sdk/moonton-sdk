...
The Python SDK for the Moonton API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Game()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/moonton-sdk/releases)) or
...
```python
client = MoontonSDK.test(testopts, sdkopts)
```
...
```
py/
├── moonton_sdk.py         -- Main SDK module
...
The main module (`moonton_sdk`) exports the SDK class.
