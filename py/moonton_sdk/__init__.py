...
from moonton_sdk.utility import register

# Load features
from moonton_sdk.feature.base_feature import MoontonBaseFeature
from moonton_sdk.features import _has_feature, _make_feature
...
class MoontonSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MoontonUtility()
        self._utility = utility

        from moonton_sdk.config import shared_config
    ...
    def get_utility(self):
        return MoontonUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MoontonSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Game(self, data=None) -> "GameEntity":
        ...
        from moonton_sdk.entity.game_entity import GameEntity
