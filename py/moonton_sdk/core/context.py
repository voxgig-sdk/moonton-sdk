...
from moonton_sdk.core.helpers import get_ctx_prop, to_map
...
class MoontonContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, MoontonResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MoontonError(code, msg, self)
