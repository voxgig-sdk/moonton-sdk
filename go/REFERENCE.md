# Moonton Golang SDK Reference

Complete API reference for the Moonton Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *MoontonSDK`
...
#### `Game(data map[string]any) MoontonEntity`
