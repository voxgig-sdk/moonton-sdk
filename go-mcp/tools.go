...
type Args struct {
	Entity string         `json:"entity" jsonschema:"game"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MoontonSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "moonton_list",
		Description: "List records from Moonton. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "moonton_load",
		Description: "Load a single record from Moonton. " +
...
func runOp(client *sdk.MoontonSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MoontonSDK, name string) (sdk.MoontonEntity, error) {
